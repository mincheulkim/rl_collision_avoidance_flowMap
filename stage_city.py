...
class StageWorld():
    ...
    def generate_goal_point(self):
        '''
        self.goal_point = test_goal_point_new(self.index)   # get index's goal_point
        self.pre_distance = 0
    ...
    def reset_pose(self):
        '''
        reset_pose = test_init_pose_new(self.index)
    ...
    def generate_random_pose(self):
        ...
        x = np.random.uniform(-9, -6)
        y = np.random.uniform(-9, -6)
